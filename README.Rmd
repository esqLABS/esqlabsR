...
# The function `exampleProjectPath()` returns the path to the example project
# configuration included in the package. Replace the variable `projectPath`
# with the path to your project configuration file.
...
outputFolder <- exportScenarioResults(simulatedScenariosResults, myProject)
