# snapshotProjectConfiguration exports project configuration to JSON with correct filename
    ...
    Output
      ...
      $projectConfiguration$rows[[16]]
      $projectConfiguration$rows[[16]]$Property
      [1] "esqlabsRVersion"
      
      $projectConfiguration$rows[[16]]$Value
      [1] "5.6.0.9002"
      
      $projectConfiguration$rows[[16]]$Description
      ...
      [13] "OverwriteFormulasInSS" "ModelFile"             "OutputPathsIds"       
      ...
      $Scenarios$Scenarios$rows[[6]]$InitialValuesSet
      [1] NA
      ...
      $Scenarios$Scenarios$rows[[7]]$InitialValuesSet
      [1] NA
      ...
      $Scenarios$Scenarios$rows[[8]]$InitialValuesSet
      [1] NA
...
---
    ...
    Output
      ...
      11   parameterIdentificationFile           ParameterIdentification.xlsx
      12                    dataFolder                                  Data/
      13                      dataFile        TestProject_TimeValuesData.xlsx
      14 dataImporterConfigurationFile esqlabs_dataImporter_configuration.xml
      15                  outputFolder                               Results/
      16               esqlabsRVersion                             5.6.0.9002
                                                                                                                                        Description
      1                                                        Path to the folder with pkml simulation files; relative to the location of this file
      ...
      5                        Name of the excel file with individual-specific model parametrization. Must be located in the "configurationsFolder"
      6                                           Name of the excel file with population information. Must be located in the "configurationsFolder"
      7                                                                                   Name of the folder containing population defined in files
      8                                             Name of the excel file with scenario definitions. Must be located in the "configurationsFolder"
      9  Name of the excel file scenario-specific parameters such as application protocol parameters. Must be located in the "configurationsFolder"
      10                                                Name of the excel file with plot definitions. Must be located in the "configurationsFolder"
      11                       Name of the excel file with parameter identification task definitions. Must be located in the "configurationsFolder"
      12                                        Path to the folder where experimental data files are located; relative to the location of this file
      13                                                         Name of the excel file with experimental data. Must be located in the "dataFolder"
      14                          Name of data importer configuration file in xml format used to load the data. Must be located in the "dataFolder"
      15                                             Path to the folder where the results should be saved to; relative to the location of this file
      16                                                                          Version of the esqlabsR package used to create this configuration
      ...
      6                <NA>                <NA>               <NA>        <NA>
      7      Protocol_250mg             0,120,1                  h       FALSE
      8      Protocol_500mg             0,120,1                  h       FALSE
        SteadyStateTime SteadyStateTimeUnit OverwriteFormulasInSS      ModelFile
      1            <NA>                <NA>                    NA Aciclovir.pkml
      2             500                 min                    NA Aciclovir.pkml
      3            <NA>                <NA>                    NA Aciclovir.pkml
      4            <NA>                <NA>                    NA Aciclovir.pkml
      5            <NA>                <NA>                    NA Aciclovir.pkml
      6            <NA>                <NA>                    NA Aciclovir.pkml
      7            <NA>                <NA>                    NA Aciclovir.pkml
      8            <NA>                <NA>                    NA Aciclovir.pkml
                           OutputPathsIds
      1                     Aciclovir_PVB
