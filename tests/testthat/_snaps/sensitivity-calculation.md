# sensitivityCalculation PK parameters tidy dataframe is as expected
    ...
    Output
      ...
      1 ParameterFactor         0.1000      0.7750      1.50000       5.77500 
      2 ParameterValue         -1.9400     -0.6305     -0.14550      -0.56017 
      3 PKParameterValue        0.1833      0.1833     50.96473    1382.72676 
      4 PercentChangePK        -2.6806      0.0000      0.00000       3.31332 
      5 SensitivityPKParameter  0.0000      0.0000      0.00306       0.04174 
        `3rd Qu.`   Max.        `NA's`     
        <table[1d]> <table[1d]> <table[1d]>
      1    6.50000    20.0000   NA         
      2   -0.07518    -0.0097   NA         
      3 4059.14475  4154.5850   NA         
      4    0.82553    37.6058   NA         
      5    0.02076     0.2877    3         
...
---
    ...
    Output
      ...
      5 SensitivityPKParameter   0.000000  0.0000000    1.000000      0.666668
        `3rd Qu.`   Max.        `NA's`     
        <table[1d]> <table[1d]> <table[1d]>
...
---
    ...
    Output
      ...
      # A tibble: 5 x 8
        column                 Min.        `1st Qu.`   Median      Mean       
        <chr>                  <table[1d]> <table[1d]> <table[1d]> <table[1d]>
      1 ParameterFactor          0.1000     0.7750      1.50000       5.7750  
      2 ParameterValue           0.1000     0.7750      1.50000       5.7750  
      3 PKParameterValue         0.1667     0.1833     49.78161    1210.6412  
      4 PercentChangePK        -52.4018    -9.7478      0.00000      -5.9048  
      5 SensitivityPKParameter  -1.1589    -0.1689     -0.03822      -0.1949  
        `3rd Qu.`   Max.        `NA's`     
        <table[1d]> <table[1d]> <table[1d]>
      1    6.500000   20.00     NA         
      2    6.500000   20.00     NA         
