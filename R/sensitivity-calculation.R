...
#' parameters. The same variation range is applied to all specified parameters.
...
#' parameters, run `names(ospsuite::StandardPKParameter)`. By default, only the
#' following parameters will be considered: `"C_max"`, `"t_max"`, `"AUC_inf"`.
