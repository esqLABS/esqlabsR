#' @title LegacyScenario
#' @docType class
#' @description Legacy simulation scenario built from a `ScenarioConfiguration`
#'   read from Excel. Soft-deprecated -- use [loadProject()] +
#'   [runScenarios()] with a `Project` instead.
#' @format NULL
#' @export
LegacyScenario <- R6::R6Class(
  "LegacyScenario",
  cloneable = FALSE,
  active = list(
  ...
  public = list(
    ...
    #' @returns A new `LegacyScenario` object.
    initialize = function(
      ...
      lifecycle::deprecate_soft(
        when = "6.0.0",
        what = "LegacyScenario$new()",
        with = "loadProject()",
        details = paste(
          "The Excel-driven Scenario class is deprecated. Use",
          "loadProject() + runScenarios(project, ...) for the",
          "JSON-first workflow."
        )
      )
