...
.validateCrossReferences <- function(projectConfiguration, validationResults) {
  ...
  if (
    !is.null(validationResults$scenarios) &&
      validationResults$scenarios$is_valid()
  ) {
    scenarios_data <- validationResults$scenarios$data

    # Check IndividualId references
    if (
      !is.null(validationResults$individuals) &&
        validationResults$individuals$is_valid()
    ) {
    ...
    if (
      !is.null(validationResults$populations) &&
        validationResults$populations$is_valid()
    ) {
  ...
  if (
    !is.null(validationResults$plots) &&
      validationResults$plots$is_valid() &&
      !is.null(validationResults$scenarios) &&
      validationResults$scenarios$is_valid()
  ) {
