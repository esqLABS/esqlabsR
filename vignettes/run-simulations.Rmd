...
library(esqlabsR)
# TODO(#908): chapter 9 will rebuild this setup against the JSON workflow.
# The legacy createProjectConfiguration(ignoreVersionCheck=...) call no
# longer matches the current signature; downstream chunks are inert
# (eval = FALSE) until then.
```
