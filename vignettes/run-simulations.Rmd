...
configuration for the *'Aciclovir_iv'* scenario defined in the
...
```{r, echo = FALSE}
scenarioConfigurations$Aciclovir_iv$print(projectConfiguration = FALSE)
```
...
```{r}
scenarios$Aciclovir_iv$finalCustomParams
```
