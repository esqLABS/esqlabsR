...
object using code while wanting to use the default esqlabsR theme. `{esqlabsR}`'s
functions are fully operable by the user and can be used directly to generate
customized and good looking plots using code only.
