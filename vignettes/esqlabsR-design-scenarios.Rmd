...
For example, to simulate the model for 10 minutes with a resolution of 1 point per minute, the value of the column `SimulationTime` should be
`0, 10, 1`, and that of the column `SimulationTimeUnit` should be `min`.

For example, to simulate the model for: 

- 20 hours with a resolution of 1 point per minute, 
- then for three weeks (equals to 3\*7\*24 = 504 hours) with a
resolution of 1 point per hour, 
-finally for two days (equals to 504 + 2\*24 = 552 hours) with a resolution of 10 points per hour,
