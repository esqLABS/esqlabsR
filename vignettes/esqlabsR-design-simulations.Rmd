...
If you simply want to run the simulation with the settings as it has been exported from PK-Sim or MoBi, you can proceed to `vignette("esqlabsR-run-simulations")`.
...
Now that the you designed your own simulation, read `vignette("esqlabsR-run-simulations")` to continue the process.
To learn more about simulation design, read the following sections.
