...
- `createScenariosFromPKML()`: Creates scenario configurations from 
...
scenarioConfigs <- createScenariosFromPKML(
...
This approach is particularly useful with the new `createScenariosFromPKML()` function.
