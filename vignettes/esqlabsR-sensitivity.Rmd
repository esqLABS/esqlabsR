...
customized via the `variationRange` argument.
...
*dose*, and *glomerular filtration (GFR) fraction* affect the
...
$$ \text{Sensitivity}= \frac{\Delta \text{AUC}}{\Delta \text{lipophilicity}}\times\frac{\text{lipophilicity}}{\text{AUC}} = \frac{4015.73-3915.87}{-0.97--0.097} \times \frac{-0.97}{4015.73} = 0.0028 $$
