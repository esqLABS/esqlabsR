...
Simulation results can be saved for later use without rerun the simulation using
...
Learn more on how to run simulations in `vignette("esqlabsR-simulations")`.
...
Many other plots are available in esqlabsR, read `vignette("esqlabsR-plot-results")` 
to learn more.
