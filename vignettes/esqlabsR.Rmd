...
on the concept of combining multiple simulation results and observed data using the `DataCombined` class and creating figures using functions implemented in the `{ospsuite}` package.
