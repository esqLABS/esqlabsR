...
Scenarios are then executed by creating a `ScenarioConfiguration` class instance and calling a `runScenarios()` function with a specific scenario name (`TestScenario` in this case):
