...
-   **IndividualId**: Name (ID) of an individual. This name refers to
    ...
    the individual as defined in the `pkml` simulation without any
...
-   **ModelParameterSheets**: A list of sheet names from the
    ...
    the *IndividualId* specified for the respective scenario with the same 
    structure as the `ModelParameters.xlsx` file.
...
It is a good idea to store simulation results as `*.csv` along with simulations 
