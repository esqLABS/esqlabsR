...
-   **PopulationId**: Name (ID) of a population. This name refers to
    the name of the population as used in excel file
    `PopulationParameters.xlsx` for definition of the demographic
    properties of the simulated population. If **PopulationId** is empty, the 
    scenario is simulated as an individual simulation. Otherwise, a population as 
    defined in the sheet `Demographics` of the `PopulationParameters.xlsx` file 
    will be created and the scenario simulated as a population simulation.
...
scenarios. **Note**: You can define both an **IndividualId** and a **PopulationId**. 
In this case, individual-specific parameters from the `IndividualParameters.xlsx` 
...
are also part of the parameter set of a population will be overwritten by the population!
If e.g. you specify the GFR of the individual in the `IndividualParameters.xlsx`,
it will be overwritten by the GFR values sampled in the simulation.
