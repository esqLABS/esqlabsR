...
**Version Control**: JSON is the primary project configuration format, making it easy to track changes in Git. Use `importProjectConfigurationFromExcel()` to migrate existing Excel projects and `exportProjectConfigurationToExcel()` to generate Excel files when needed.
