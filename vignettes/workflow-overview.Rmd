...
For fitting model parameters to observed data, `esqlabsR` provides a separate
excel-based workflow for parameter identification. Learn more in
`vignette("pi-workflow")`.
